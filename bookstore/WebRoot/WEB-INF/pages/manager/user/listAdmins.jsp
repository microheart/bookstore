		...
		<script type="text/javascript">
			$(document).ready(function() {
				$(".deleteAdmin").click( function() {
					...
					if(!confirm("您确定删除此管理员吗？"))
						return false;
						
					$.post(
						"admin_deleteAdmin.action",
						{"adminId":adminId},
						function() {
							$("#admin_"+adminId).remove();
							$("#adminCount").text($("#adminCount").text()-1);
						},
						"json"
					);
				});
	...
	<body>
		<div id="wrap">
			...
			<div id="content">
				...
				<div id="main">
					<div class="right">
						<s:form action="admin_listAdminsByName" method="post" theme="simple">
						<div class="danwei">
						...
						<div>	
							<div style="text-align: left;font-weight: bold;" >共搜索到<span style="color:red" id="adminCount"><s:property value="dataPageOfAdmin.totalCount"/> </span>个管理员 </div>
							<table class="table">
								<thead>
								...
								<tbody>
								<s:iterator value="dataPageOfAdmin.data">
									<tr id="admin_${adminId}">
										<td><s:property value="loginName"/> </td>
										<td><s:property value="trueName" /> </td>
										<td><s:property value="password" /> </td>
										<td><p:dateTimeFormat value="${createTime}" /> </td>
										<td><a href="#">编辑</a>　<a href="javascript:void(0)" class="deleteAdmin" adminId="${adminId}">删除</a></td>
									</tr>									
								</s:iterator>
								</tbody>
							</table>
