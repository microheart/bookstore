			...
			<div id="content">
				...
				<div id="main">
					...
					<div class="inputKuang">
						...
						<s:form action="book_editBook" method="post" enctype="multipart/form-data" theme="simple">
							...
							<div class="danwei">
								...
								<input id="publishDate" name="publishDate" type="text" class="Wdate textbox180"
									...
									onfocus="WdatePicker({dateFmt:'yyyy-MM-dd})" value="<p:dateTimeFormat value='${book.publishDate}' pattern='yyyy-MM-dd' />" />
								<span></span>
							</div>							
							<div class="danwei">
							...
							<div class="danwei">
								...
								<select name="book.typeId" class="textbox180" style="height:auto;">
									<s:iterator value="secondTypes" id="secondType">
										<s:if test="typeId == book.typeId">
											<option value="${typeId}" selected="selected">
											<s:property value="typeName" />
										</option>						
										</s:if>
										<s:else>
							...
							<div class="danwei">
								...
								<input type="text" name="book.rebate" class="textbox180" value="0.75" />
								<span></span>
							</div>	
							<div class="danwei">
							...
							<div class="danwei">
								<span class="title"><span style="color:red">*</span>销售量:</span>
								<input type="text" name="book.saleCount" class="textbox180" value="${book.saleCount}" />
								<span></span>
							</div>													
							<div class="danwei">
							...
							<div class="danwei">
								...
								<div style="float: left;"><img src="images/thumbnails/${book.picture}"  /></div>
								<span></span>
							</div>				
